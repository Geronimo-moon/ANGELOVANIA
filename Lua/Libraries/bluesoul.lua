...
self.maxjump = 4.4                                                          --the amount of vertical velocity applied on the first frame of jumping.
local jump = 0                                                              --the current amount of vertical velocity being applied.
local decrease = 0.12                                                       --the amount by which the vertical velocity diminishes each frame.
...
self.platformhitbox = -3                                                    --distance from center of hitbox to bottom of hitbox
